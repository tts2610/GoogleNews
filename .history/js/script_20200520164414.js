...
let page = 1;
let pageSize = 6;
let currentNewsNo = result.articles.length;
const loadNews = async(page) => {
    ...
    $('#myContent').append(`<div id="currentNews" style="text-align:right;">Shown : ${result.articles.length}/${result.totalResults} news</div>`);
}
