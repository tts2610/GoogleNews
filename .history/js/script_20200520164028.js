...
$('#myContent').append(`<div>Shown : ${result.articles.length}/${result.totalResults} news</div>);
}
...
function render(result) {
    ...
    div class = "text p-4" >
    <
    h3 class = "mb-2" > < a href = "single.html" > $ { x.title } < /a></h
    3 >
    <
    div class = "meta-wrap" >
    <
    ...
    /div> <
    /div>`
    midNum = i + 1; firstNum = firstNum + 3;
}
if (i == midNum) {
