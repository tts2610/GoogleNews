            ...
            <div class="col-4 d-flex">
                <div class="blog-entry-left">
                    ...
                    <div class="text p-4">
                        ...
                        <div class="meta-wrap">
                            <p class="meta">
                                <span><i class="icon-calendar mr-2"></i>${moment(x.publishedAt, moment("yyyy-MM-dd[T]HH:mm:ss[Z]","YYYYMMDD")).fromNow()}</span>
                ...
                <div class="col-md-12">
                    <div class="blog-entry ftco-animate d-md-flex align-items-center">
                        <div class="text text-2 text-md-right pr-4">
                            ...
                            <div class="meta-wrap">
                                <p class="meta">
                                    <span><i class="icon-calendar mr-2"></i>${moment(x.publishedAt, moment().format("yyyy-MM-dd[T]HH:mm:ss[Z]","YYYYMMDD")).fromNow()}</span>
                                    <span><a href="single.html"><i class="icon-folder-o mr-2"></i>${x.source.name}</a></span>
                                    <span><i class="icon-comment2 mr-2"></i>5 Comment</span>
                                </p>
                            </div>
